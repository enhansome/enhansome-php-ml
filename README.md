...
Inspired by [awesome-php](https://github.com/ziadoz/awesome-php) ⭐ 32,686 | 🐛 89 | 📅 2026-07-13 and the broader **Awesome** ecosystem.
...
* **Classic ML / traditional models** – start with [php-ai/php-ml](https://gitlab.com/php-ai/php-ml) and [RubixML/RubixML](https://github.com/RubixML/RubixML) ⭐ 2,204 | 🐛 62 | 🌐 PHP | 📅 2026-09-10.
* **RAG (Retrieval-Augmented Generation)** – combine [php-rag](https://github.com/mzarnecki/php-rag) ⭐ 67 | 🐛 0 | 🌐 PHP | 📅 2026-07-19 with vector databases like [pgvector](https://github.com/pgvector/pgvector) ⭐ 22,972 | 🐛 16 | 🌐 C | 📅 2026-09-10 or [Meilisearch](https://github.com/meilisearch/meilisearch-php) ⭐ 757 | 🐛 60 | 🌐 PHP | 📅 2026-09-09.
...
* **General ML:** 🌟 [RubixML/RubixML](https://github.com/RubixML/RubixML) ⭐ 2,204 | 🐛 62 | 🌐 PHP | 📅 2026-09-10 for end-to-end ML pipelines.
...
* **Data processing:** 🌟 [flow-php/flow](https://github.com/flow-php/flow) ⭐ 865 | 🐛 45 | 🌐 PHP | 📅 2026-09-09 for typed ETL-style pipelines.
...
* 🌟 [RubixML/RubixML](https://github.com/RubixML/RubixML "Link to resource") ⭐ 2,204 | 🐛 62 | 🌐 PHP | 📅 2026-09-10 – ![GitHub stars](https://img.shields.io/github/stars/RubixML/RubixML?style=social) High-level ML framework with pipelines and datasets
...
* 🌟 [pgvector/pgvector](https://github.com/pgvector/pgvector "Link to resource") ⭐ 22,972 | 🐛 16 | 🌐 C | 📅 2026-09-10 – ![GitHub stars](https://img.shields.io/github/stars/pgvector/pgvector?style=social) Vector similarity search extension for PostgreSQL
...
* 🌟 [flow-php/flow](https://github.com/flow-php/flow "Link to resource") ⭐ 865 | 🐛 45 | 🌐 PHP | 📅 2026-09-09 – ![GitHub stars](https://img.shields.io/github/stars/flow-php/flow?style=social) Data processing and ETL framework for PHP with typed pipelines
...
* 🌟 [neuron-core/neuron-ai](https://github.com/neuron-core/neuron-ai "Link to resource") ⭐ 2,091 | 🐛 7 | 🌐 PHP | 📅 2026-09-10 – ![GitHub stars](https://img.shields.io/github/stars/neuron-core/neuron-ai?style=social) PHP agentic AI framework for building and orchestrating LLMs, RAG etc
* 🌟 [googleapis/google-cloud-php](https://github.com/googleapis/google-cloud-php "Link to resource") ⭐ 1,183 | 🐛 70 | 🌐 PHP | 📅 2026-09-10 – ![GitHub stars](https://img.shields.io/github/stars/googleapis/google-cloud-php?style=social) Official PHP client library for Google Cloud APIs (including ML/AI services like Vision, Translate, AutoML, Vertex AI, etc.)
...
* [symfony/console](https://github.com/symfony/console "Link to resource") ⭐ 9,811 | 🐛 0 | 🌐 PHP | 📅 2026-09-10 – CLI applications
* [nunomaduro/collision](https://github.com/nunomaduro/collision "Link to resource") ⭐ 4,658 | 🐛 44 | 🌐 PHP | 📅 2026-08-04 – CLI error handling (useful for ML tools)
...
* [guanguans/ai-commit](https://github.com/guanguans/ai-commit "Link to resource") ⭐ 394 | 🐛 0 | 🌐 PHP | 📅 2026-09-07 – AI-powered CLI to automatically generate conventional Git commit messages
...
* 🌟 [laravel/boost](https://github.com/laravel/boost "Link to resource") ⭐ 3,611 | 🐛 15 | 🌐 PHP | 📅 2026-09-10 – ![GitHub stars](https://img.shields.io/github/stars/laravel/boost?style=social) Official Laravel Boost: a development server and AI context provider that accelerates AI-assisted code generation by giving AI tools detailed insight into your Laravel app (MCP server, schema inspection, docs + guidelines)
* 🌟 [laravel/ai](https://github.com/laravel/ai "Link to resource") ⭐ 1,147 | 🐛 45 | 🌐 PHP | 📅 2026-09-10 – ![GitHub stars](https://img.shields.io/github/stars/laravel/ai?style=social) The Laravel AI SDK: a unified, expressive Laravel API for interacting with AI providers (LLMs, images, embeddings, agents, tools)
...
* 🌟 [symfony/ai](https://github.com/symfony/ai) ⭐ 1,196 | 🐛 164 | 🌐 PHP | 📅 2026-09-08 – ![GitHub stars](https://img.shields.io/github/stars/symfony/ai?style=social "Link to resource") – Symfony AI: built-in AI components and bundles for Symfony apps
...
* [WordPress/php-ai-client](https://github.com/WordPress/php-ai-client "Link to resource") ⭐ 307 | 🐛 70 | 🌐 PHP | 📅 2026-09-10 – Provider-agnostic PHP AI SDK offering a unified API for interacting with multiple LLM providers (OpenAI, Anthropic, Gemini, etc.), supporting text, image, speech, streaming, and multimodal operations
...
* [Awesome PHP](https://github.com/ziadoz/awesome-php "Link to resource") ⭐ 32,686 | 🐛 89 | 📅 2026-07-13
