...
[![GitHub stars](https://img.shields.io/github/stars/apphp/awesome-php-ml?style=social)](https://github.com/apphp/awesome-php-ml) ⭐ 116 | 🐛 0 | 🌐 PHP | 📅 2026-09-19
[![Resources](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/apphp/awesome-php-ml/main/badge/resources.json)](https://github.com/apphp/awesome-php-ml#readme) ⭐ 116 | 🐛 0 | 🌐 PHP | 📅 2026-09-19
[![Last commit](https://img.shields.io/github/last-commit/apphp/awesome-php-ml)](https://github.com/apphp/awesome-php-ml/commits) ⭐ 116 | 🐛 0 | 🌐 PHP | 📅 2026-09-19
[![License](https://img.shields.io/badge/license-MIT-green)](https://github.com/apphp/awesome-php-ml/blob/main/LICENSE) ⭐ 116 | 🐛 0 | 🌐 PHP | 📅 2026-09-19
[![Link Check](https://github.com/apphp/awesome-php-ml/actions/workflows/link-check.yml/badge.svg)](https://github.com/apphp/awesome-php-ml/actions/workflows/link-check.yml) ⭐ 116 | 🐛 0 | 🌐 PHP | 📅 2026-09-19
...
Inspired by [awesome-php](https://github.com/ziadoz/awesome-php) ⭐ 32,699 | 🐛 92 | 📅 2026-07-13 and the broader **Awesome** ecosystem.
...
* **Classic ML / traditional models** – start with [php-ai/php-ml](https://gitlab.com/php-ai/php-ml) and [RubixML/RubixML](https://github.com/RubixML/RubixML) ⭐ 2,207 | 🐛 65 | 🌐 PHP | 📅 2026-09-20.
* **RAG (Retrieval-Augmented Generation)** – combine [php-rag](https://github.com/mzarnecki/php-rag) ⭐ 67 | 🐛 0 | 🌐 PHP | 📅 2026-07-19 with vector databases like [pgvector](https://github.com/pgvector/pgvector) ⭐ 23,102 | 🐛 17 | 🌐 C | 📅 2026-09-10 or [Meilisearch](https://github.com/meilisearch/meilisearch-php) ⭐ 757 | 🐛 60 | 🌐 PHP | 📅 2026-09-16.
...
* **I want to build a Laravel RAG app**\
  Use an LLM client like 🌟 [openai-php/client](https://github.com/openai-php/client) ⭐ 5,831 | 🐛 26 | 🌐 PHP | 📅 2026-09-17, embeddings + vector search via 🌟 [LLPhant/LLPhant](https://github.com/LLPhant/LLPhant) ⭐ 1,708 | 🐛 36 | 🌐 PHP | 📅 2026-09-07 with 🌟 [pgvector/pgvector](https://github.com/pgvector/pgvector) ⭐ 23,102 | 🐛 17 | 🌐 C | 📅 2026-09-10 or 🌟 [meilisearch/meilisearch-php](https://github.com/meilisearch/meilisearch-php) ⭐ 757 | 🐛 60 | 🌐 PHP | 📅 2026-09-16, and orchestrate agents/RAG flows with 🌟 [neuron-core/neuron-ai](https://github.com/neuron-core/neuron-ai) ⭐ 2,100 | 🐛 6 | 🌐 PHP | 📅 2026-09-20, integrating into Laravel using 🌟 [openai-php/laravel](https://github.com/openai-php/laravel) ⭐ 3,752 | 🐛 13 | 🌐 PHP | 📅 2026-09-17 and the packages under [Laravel & Framework Integrations](#laravel--framework-integrations).

* **I only need translation or vision**\
  For translation, see 🌟 [deepl-php](https://github.com/DeepLcom/deepl-php) ⭐ 260 | 🐛 29 | 🌐 PHP | 📅 2026-08-26 and 🌟 [googleapis/google-cloud-php](https://github.com/googleapis/google-cloud-php) ⭐ 1,182 | 🐛 73 | 🌐 PHP | 📅 2026-09-18 under [Interop & Model Serving](#interop--model-serving). For image/vision workloads, combine [Computer Vision, Image & Video Processing](#computer-vision-image--video-processing) libraries with cloud AI services via 🌟 [symfony/ai](https://github.com/symfony/ai) ⭐ 1,206 | 🐛 152 | 🌐 PHP | 📅 2026-09-20 or [openai-php/client](https://github.com/openai-php/client) ⭐ 5,831 | 🐛 26 | 🌐 PHP | 📅 2026-09-17 from [LLMs & AI APIs](#llms--ai-apis).

### Recommended core stack

These are opinionated defaults you can reach for when you just want something that works in production.

* **LLM clients:** 🌟 [openai-php/client](https://github.com/openai-php/client) ⭐ 5,831 | 🐛 26 | 🌐 PHP | 📅 2026-09-17 and 🌟 [google-gemini-php/client](https://github.com/google-gemini-php/client) ⭐ 411 | 🐛 10 | 🌐 PHP | 📅 2025-12-29 for major model providers.
* **General ML:** 🌟 [RubixML/RubixML](https://github.com/RubixML/RubixML) ⭐ 2,207 | 🐛 65 | 🌐 PHP | 📅 2026-09-20 for end-to-end ML pipelines.
* **Embeddings & vector search:** 🌟 [LLPhant/LLPhant](https://github.com/LLPhant/LLPhant) ⭐ 1,708 | 🐛 36 | 🌐 PHP | 📅 2026-09-07 with 🌟 [pgvector/pgvector](https://github.com/pgvector/pgvector) ⭐ 23,102 | 🐛 17 | 🌐 C | 📅 2026-09-10, 🌟 [pgvector/pgvector-php](https://github.com/pgvector/pgvector-php) ⭐ 197 | 🐛 0 | 🌐 PHP | 📅 2026-07-09, 🌟 [meilisearch/meilisearch-php](https://github.com/meilisearch/meilisearch-php) ⭐ 757 | 🐛 60 | 🌐 PHP | 📅 2026-09-16 or 🌟 [algolia/algoliasearch-client-php](https://github.com/algolia/algoliasearch-client-php) ⭐ 697 | 🐛 21 | 🌐 PHP | 📅 2026-09-18.
* **Data processing:** 🌟 [flow-php/flow](https://github.com/flow-php/flow) ⭐ 868 | 🐛 35 | 🌐 PHP | 📅 2026-09-20 for typed ETL-style pipelines.
...
* 🌟 [RubixML/RubixML](https://github.com/RubixML/RubixML "Link to resource") ⭐ 2,207 | 🐛 65 | 🌐 PHP | 📅 2026-09-20 – ![GitHub stars](https://img.shields.io/github/stars/RubixML/RubixML?style=social) High-level ML framework with pipelines and datasets
...
* ⚠️ [patrickschur/language-detection](https://github.com/patrickschur/language-detection "Link to resource") ⭐ 858 | 🐛 7 | 🌐 PHP | 📅 2025-03-25 – Language detection library
...
* 🧪 [RubixML/Sentiment](https://github.com/RubixML/Sentiment "Link to resource") ⭐ 119 | 🐛 3 | 🌐 PHP | 📅 2026-09-16 – Example project demonstrating sentiment analysis with a neural network (IMDB reviews) using Rubix ML in PHP
...
* 🌟 [Intervention/image](https://github.com/Intervention/image "Link to resource") ⭐ 14,372 | 🐛 22 | 🌐 PHP | 📅 2026-09-19 – ![GitHub stars](https://img.shields.io/github/stars/Intervention/image?style=social) Image manipulation library for CV preprocessing
...
* 🌟 [brick/math](https://github.com/brick/math "Link to resource") ⭐ 2,176 | 🐛 0 | 🌐 PHP | 📅 2026-09-12 – ![GitHub stars](https://img.shields.io/github/stars/brick/math?style=social) Arbitrary-precision arithmetic for PHP (BigInteger, BigDecimal, BigRational)
...
* 🌟 [RubixML/Tensor](https://github.com/RubixML/Tensor "Link to resource") ⭐ 280 | 🐛 1 | 🌐 PHP | 📅 2026-09-20 – ![GitHub stars](https://img.shields.io/github/stars/RubixML/Tensor?style=social) N-dimensional tensors for numerical computing
...
* 🌟 [RubixML/numpower](https://github.com/RubixML/numpower "Link to resource") ⭐ 23 | 🐛 0 | 🌐 PHP | 📅 2026-09-01 – High-performance numerical computing library inspired by NumPy
...
* 🌟 [ankane/onnxruntime-php](https://github.com/ankane/onnxruntime-php "Link to resource") ⭐ 153 | 🐛 1 | 🌐 PHP | 📅 2026-09-10 – ![GitHub stars](https://img.shields.io/github/stars/ankane/onnxruntime-php?style=social) Run ONNX models from PHP
...
* 🌟 [openai-php/client](https://github.com/openai-php/client "Link to resource") ⭐ 5,831 | 🐛 26 | 🌐 PHP | 📅 2026-09-17 – ![GitHub stars](https://img.shields.io/github/stars/openai-php/client?style=social) Official OpenAI PHP client
* 🌟 [dtyq/magic](https://github.com/dtyq/magic "Link to resource") ⭐ 5,037 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-12 – ![GitHub stars](https://img.shields.io/github/stars/dtyq/magic?style=social) Open-source enterprise AI agent platform with generalist agents, workflow orchestration, IM integration, collaborative office features, and support for multiple LLMs
* 🌟 [orhanerday/open-ai](https://github.com/orhanerday/open-ai "Link to resource") ⭐ 2,362 | 🐛 32 | 🌐 PHP | 📅 2025-03-12 – ![GitHub stars](https://img.shields.io/github/stars/orhanerday/open-ai?style=social) Popular OpenAI PHP SDK
...
* 🌟 [google-gemini-php/client](https://github.com/google-gemini-php/client "Link to resource") ⭐ 411 | 🐛 10 | 🌐 PHP | 📅 2025-12-29 – ![GitHub stars](https://img.shields.io/github/stars/google-gemini-php/client?style=social) Gemini PHP is a community-maintained PHP API client that allows you to interact with the Gemini AI API
* [cognesy/instructor-php](https://github.com/cognesy/instructor-php "Link to resource") ⭐ 327 | 🐛 2 | 🌐 PHP | 📅 2026-09-17 – Structured-output helper for LLM responses
...
* [aimeos/prisma](https://github.com/aimeos/prisma "Link to resource") ⭐ 229 | 🐛 1 | 🌐 PHP | 📅 2026-09-19 – ![GitHub stars](https://img.shields.io/github/stars/aimeos/prisma?style=social) Lightweight PHP package providing a unified interface for text, image, audio, and video AI providers
* [ArdaGnsrn/ollama-php](https://github.com/ArdaGnsrn/ollama-php "Link to resource") ⭐ 208 | 🐛 7 | 🌐 PHP | 📅 2026-09-14 – A PHP client library for the Ollama LLM server, enabling completions, chat, model management, and embeddings via Ollama's API
...
* [aiaccess/ai-access](https://github.com/aiaccess/ai-access "Link to resource") ⭐ 62 | 🐛 0 | 🌐 PHP | 📅 2026-08-26 – Unified PHP AI client providing a consistent interface for multiple providers (OpenAI, Anthropic, Gemini, DeepSeek, Grok) with support for chat, embeddings, batch processing, and provider switching
* [mozex/anthropic-php](https://github.com/mozex/anthropic-php "Link to resource") ⭐ 48 | 🐛 0 | 🌐 PHP | 📅 2026-09-13 – Community-maintained PHP API client for the Anthropic (Claude) AI API, supporting messages, streaming, tool use, and batch processing
...
* [softcreatr/php-mistral-ai-sdk](https://github.com/SoftCreatR/php-mistral-ai-sdk "Link to resource") ⭐ 19 | 🐛 0 | 🌐 PHP | 📅 2026-09-12 – PHP SDK for the Mistral AI API, providing an easy wrapper to call Mistral's LLM and AI endpoints (chat, embeddings, fine-tuning etc.)
...
* [utopia-php/agents](https://github.com/utopia-php/agents "Link to resource") ⭐ 10 | 🐛 2 | 🌐 PHP | 📅 2026-09-16 – Simple, lightweight PHP library for AI agent orchestration with multi-provider support (OpenAI, Anthropic, Deepseek, Perplexity, XAI)
...
* 🧪 [papi-ai/papi-core](https://github.com/papi-ai/papi-core "Link to resource") ⭐ 6 | 🐛 1 | 🌐 PHP | 📅 2026-07-31 – Framework-agnostic PHP library for building AI agents with multi-provider support, tool calling, structured output, streaming, and observability hooks
...
* [prism-php/relay](https://github.com/prism-php/relay "Link to resource") ⭐ 153 | 🐛 13 | 🌐 PHP | 📅 2026-03-20 – MCP client for Prism that lets PHP/Laravel AI agents connect to external Model Context Protocol servers and use their tools
...
* [yethee/tiktoken-php](https://github.com/yethee/tiktoken-php "Link to resource") ⭐ 167 | 🐛 4 | 🌐 PHP | 📅 2026-03-10 – PHP implementation of OpenAI's *tiktoken* tokenizer for token counting and optimization
* [HelgeSverre/toon-php](https://github.com/HelgeSverre/toon-php "Link to resource") ⭐ 130 | 🐛 1 | 🌐 PHP | 📅 2026-09-06 – PHP implementation of TOON, a compact data format for reducing token usage when sending structured data to LLMs
* [Gioni06/GPT3Tokenizer](https://github.com/Gioni06/GPT3Tokenizer "Link to resource") ⭐ 83 | 🐛 1 | 🌐 PHP | 📅 2024-01-16 – PHP tokenizer compatible with GPT-3 style models
...
* 🌟 [pgvector/pgvector](https://github.com/pgvector/pgvector "Link to resource") ⭐ 23,102 | 🐛 17 | 🌐 C | 📅 2026-09-10 – ![GitHub stars](https://img.shields.io/github/stars/pgvector/pgvector?style=social) Vector similarity search extension for PostgreSQL
* 🌟 [LLPhant/LLPhant](https://github.com/LLPhant/LLPhant "Link to resource") ⭐ 1,708 | 🐛 36 | 🌐 PHP | 📅 2026-09-07 – ![GitHub stars](https://img.shields.io/github/stars/LLPhant/LLPhant?style=social) Comprehensive PHP generative AI framework supporting LLMs, embeddings, vector search and more
* 🌟 [meilisearch/meilisearch-php](https://github.com/meilisearch/meilisearch-php "Link to resource") ⭐ 757 | 🐛 60 | 🌐 PHP | 📅 2026-09-16 – ![GitHub stars](https://img.shields.io/github/stars/meilisearch/meilisearch-php?style=social) Client for Meilisearch search engine
* 🌟 [algolia/algoliasearch-client-php](https://github.com/algolia/algoliasearch-client-php "Link to resource") ⭐ 697 | 🐛 21 | 🌐 PHP | 📅 2026-09-18 – ![GitHub stars](https://img.shields.io/github/stars/algolia/algoliasearch-client-php?style=social) Algolia search client
...
* [CodeWithKyrian/chromadb-php](https://github.com/CodeWithKyrian/chromadb-php "Link to resource") ⭐ 85 | 🐛 1 | 🌐 PHP | 📅 2025-12-06 – PHP client for ChromaDB, enabling vector similarity search and embedding storage for AI and RAG applications
...
* [league/csv](https://github.com/thephpleague/csv "Link to resource") ⭐ 3,483 | 🐛 2 | 🌐 PHP | 📅 2026-09-19 – CSV data processing
* 🌟 [cocur/slugify](https://github.com/cocur/slugify "Link to resource") ⭐ 2,896 | 🐛 32 | 🌐 PHP | 📅 2025-11-27 – ![GitHub stars](https://img.shields.io/github/stars/cocur/slugify?style=social) Converts strings into URL-friendly slugs, includes integrations for many frameworks
* [symfony/serializer](https://github.com/symfony/serializer "Link to resource") ⭐ 2,536 | 🐛 0 | 🌐 PHP | 📅 2026-09-16 – Data normalization & serialization
* [spatie/data-transfer-object](https://github.com/spatie/data-transfer-object "Link to resource") ⚠️ Archived – Strongly typed DTOs
* 🌟 [php-ds/ext-ds](https://github.com/php-ds/ext-ds "Link to resource") ⭐ 2,150 | 🐛 30 | 🌐 PHP | 📅 2026-09-17 – ![GitHub stars](https://img.shields.io/github/stars/php-ds/ext-ds?style=social) PHP Data Structures extension: efficient vectors, maps, sets, etc.
* 🌟 [flow-php/flow](https://github.com/flow-php/flow "Link to resource") ⭐ 868 | 🐛 35 | 🌐 PHP | 📅 2026-09-20 – ![GitHub stars](https://img.shields.io/github/stars/flow-php/flow?style=social) Data processing and ETL framework for PHP with typed pipelines
* [paperdoc-dev/paperdoc-lib](https://github.com/paperdoc-dev/paperdoc-lib "Link to resource") ⭐ 137 | 🐛 1 | 🌐 PHP | 📅 2026-08-29 – ![GitHub stars](https://img.shields.io/github/stars/paperdoc-dev/paperdoc-lib?style=social) Zero-dependency PHP library for generating, parsing, and converting documents such as PDF, HTML, CSV, DOCX, XLSX, PPTX, and Markdown
...
* 🌟 [neuron-core/neuron-ai](https://github.com/neuron-core/neuron-ai "Link to resource") ⭐ 2,100 | 🐛 6 | 🌐 PHP | 📅 2026-09-20 – ![GitHub stars](https://img.shields.io/github/stars/neuron-core/neuron-ai?style=social) PHP agentic AI framework for building and orchestrating LLMs, RAG etc
* 🌟 [googleapis/google-cloud-php](https://github.com/googleapis/google-cloud-php "Link to resource") ⭐ 1,182 | 🐛 73 | 🌐 PHP | 📅 2026-09-18 – ![GitHub stars](https://img.shields.io/github/stars/googleapis/google-cloud-php?style=social) Official PHP client library for Google Cloud APIs (including ML/AI services like Vision, Translate, AutoML, Vertex AI, etc.)
...
* [symfony/console](https://github.com/symfony/console "Link to resource") ⭐ 9,814 | 🐛 0 | 🌐 PHP | 📅 2026-09-18 – CLI applications
* [nunomaduro/collision](https://github.com/nunomaduro/collision "Link to resource") ⭐ 4,658 | 🐛 47 | 🌐 PHP | 📅 2026-08-04 – CLI error handling (useful for ML tools)
* [symfony/http-client](https://github.com/symfony/http-client "Link to resource") ⭐ 2,030 | 🐛 0 | 🌐 PHP | 📅 2026-09-15 – Robust HTTP client for AI APIs
...
* 🧪 [context-hub/generator](https://github.com/context-hub/generator "Link to resource") ⭐ 343 | 🐛 18 | 🌐 PHP | 📅 2026-03-11 – Context-as-Code (CTX) tool that extracts and organizes codebase context into structured documents and MCP servers for LLM-assisted development
...
* 🧪 [mariorazo97/single-file-php-ai](https://github.com/mariorazo97/single-file-php-ai "Link to resource") ⭐ 52 | 🐛 0 | 🌐 PHP | 📅 2025-11-26 – Drop-in single-file PHP AI chat interface for Ollama and OpenAI, with no Node.js, Docker, database, or build step
...
* 🌟 [openai-php/laravel](https://github.com/openai-php/laravel "Link to resource") ⭐ 3,752 | 🐛 13 | 🌐 PHP | 📅 2026-09-17 – ![GitHub stars](https://img.shields.io/github/stars/openai-php/laravel?style=social) Laravel OpenAI integration
* 🌟 [laravel/boost](https://github.com/laravel/boost "Link to resource") ⭐ 3,624 | 🐛 15 | 🌐 PHP | 📅 2026-09-19 – ![GitHub stars](https://img.shields.io/github/stars/laravel/boost?style=social) Official Laravel Boost: a development server and AI context provider that accelerates AI-assisted code generation by giving AI tools detailed insight into your Laravel app (MCP server, schema inspection, docs + guidelines)
* 🌟 [laravel/ai](https://github.com/laravel/ai "Link to resource") ⭐ 1,177 | 🐛 30 | 🌐 PHP | 📅 2026-09-19 – ![GitHub stars](https://img.shields.io/github/stars/laravel/ai?style=social) The Laravel AI SDK: a unified, expressive Laravel API for interacting with AI providers (LLMs, images, embeddings, agents, tools)
* [maestroerror/LarAgent](https://github.com/maestroerror/LarAgent "Link to resource") ⭐ 644 | 🐛 7 | 🌐 PHP | 📅 2026-08-20 – AI agent development framework for Laravel: define agents, tools, workflows, and manage LLM interactions with an Eloquent-style API
...
* [moe-mizrak/laravel-openrouter](https://github.com/moe-mizrak/laravel-openrouter "Link to resource") ⭐ 159 | 🐛 0 | 🌐 PHP | 📅 2026-06-11 – Laravel package to integrate OpenRouter LLM API
* 🌟 [neuron-core/neuron-laravel](https://github.com/neuron-core/neuron-laravel "Link to resource") ⭐ 121 | 🐛 0 | 🌐 PHP | 📅 2026-09-18 – ![GitHub stars](https://img.shields.io/github/stars/neuron-core/neuron-laravel?style=social) Laravel integration for Neuron Core to build and orchestrate AI/LLM workflows
...
* 🧪 [builtbyberry/laravel-swarm](https://github.com/builtbyberry/laravel-swarm "Link to resource") ⭐ 35 | 🐛 31 | 🌐 PHP | 📅 2026-09-20 – Multi-agent swarm orchestration for Laravel, built on Laravel AI, with sequential, parallel, hierarchical, queued, streamed, and durable workflows
...
* 🌟 [prism-php/prism](https://github.com/prism-php/prism "Link to resource") ⭐ 2,425 | 🐛 112 | 🌐 PHP | 📅 2026-03-20 – ![GitHub stars](https://img.shields.io/github/stars/prism-php/prism?style=social) Unified Laravel-native interface for working with LLMs (OpenAI, Anthropic, Gemini, Ollama, etc.), supporting text generation, structured outputs, tools/function calling, and multi-step AI workflows
* [spatie/laravel-data](https://github.com/spatie/laravel-data "Link to resource") ⭐ 1,793 | 🐛 18 | 🌐 PHP | 📅 2026-09-01 – Typed DTOs for API & AI responses
...
* 🧪 [subhashladumor1/laravel-ai-guard](https://github.com/subhashladumor1/laravel-ai-guard "Link to resource") ⭐ 30 | 🐛 0 | 🌐 PHP | 📅 2026-02-14 – Laravel package for tracking LLM token usage, estimating AI costs, enforcing per-user or per-tenant budgets, and preventing unexpected AI billing spikes

### MCP / Tooling

* [RedberryProducts/mcp-client-laravel](https://github.com/RedberryProducts/mcp-client-laravel "Link to resource") ⭐ 13 | 🐛 4 | 🌐 PHP | 📅 2026-09-14 – Laravel-native MCP client for connecting to Model Context Protocol servers via HTTP or STDIO, retrieving tools and resources, and integrating external agent capabilities into Laravel apps
...
* 🌟 [laravel/scout](https://github.com/laravel/scout "Link to resource") ⭐ 1,677 | 🐛 7 | 🌐 PHP | 📅 2026-09-18 – ![GitHub stars](https://img.shields.io/github/stars/laravel/scout?style=social) – Search abstraction (useful for vector search)
...
* 🌟 [symfony/ai](https://github.com/symfony/ai) ⭐ 1,206 | 🐛 152 | 🌐 PHP | 📅 2026-09-20 – ![GitHub stars](https://img.shields.io/github/stars/symfony/ai?style=social "Link to resource") – Symfony AI: built-in AI components and bundles for Symfony apps
* [openai-php/symfony](https://github.com/openai-php/symfony "Link to resource") ⭐ 220 | 🐛 3 | 🌐 PHP | 📅 2026-08-04 – OpenAI PHP for Symfony integration
* 🧪 [symfony/ai-platform](https://github.com/symfony/ai-platform "Link to resource") ⭐ 54 | 🐛 0 | 🌐 PHP | 📅 2026-09-20 – Experimental Symfony AI Platform component providing a unified abstraction for interacting with AI models, providers, messages, embeddings, speech, and provider-specific bridge packages
* [symfony/mcp-bundle](https://github.com/symfony/mcp-bundle "Link to resource") ⭐ 52 | 🐛 0 | 🌐 PHP | 📅 2026-09-19 – Symfony bundle for exposing MCP tools, prompts, and resources over HTTP or STDIO using the official MCP SDK
* 🧪 [symfony/ai-agent](https://github.com/symfony/ai-agent "Link to resource") ⭐ 33 | 🐛 0 | 🌐 PHP | 📅 2026-09-20 – Symfony AI Agent component for building agentic applications that interact with users, execute tasks, and manage workflows
* 🧪 [symfony/ai-bundle](https://github.com/symfony/ai-bundle "Link to resource") ⭐ 32 | 🐛 0 | 🌐 PHP | 📅 2026-09-20 – Symfony integration bundle that brings together Symfony AI components for agents, chat, platforms, stores, RAG, tools, and configuration
* [symfony/ai-store](https://github.com/symfony/ai-store "Link to resource") ⭐ 22 | 🐛 0 | 🌐 PHP | 📅 2026-09-19 – Symfony AI component providing a vector store abstraction for semantic search and RAG workflows
...
* [WordPress/php-ai-client](https://github.com/WordPress/php-ai-client "Link to resource") ⭐ 308 | 🐛 76 | 🌐 PHP | 📅 2026-09-16 – Provider-agnostic PHP AI SDK offering a unified API for interacting with multiple LLM providers (OpenAI, Anthropic, Gemini, etc.), supporting text, image, speech, streaming, and multimodal operations
...
* [Awesome PHP](https://github.com/ziadoz/awesome-php "Link to resource") ⭐ 32,699 | 🐛 92 | 📅 2026-07-13
* 🧪 [dykyi-roman/awesome-claude-code](https://github.com/dykyi-roman/awesome-claude-code "Link to resource") ⭐ 98 | 🐛 0 | 🌐 Python | 📅 2026-08-16 – Curated collection of commands, agents, skills, hooks, and tools for enhancing Claude Code AI workflows
...
* [tensorflow/tfjs](https://github.com/tensorflow/tfjs "Link to resource") ⭐ 19,141 | 🐛 384 | 🌐 TypeScript | 📅 2026-06-23 – JavaScript machine learning platform for training and running models in the browser or Node.js (TensorFlow\.js)
