...
Inspired by [awesome-php](https://github.com/ziadoz/awesome-php) ⭐ 32,669 | 🐛 85 | 📅 2026-07-13 and the broader **Awesome** ecosystem.
...
* **Classic ML / traditional models** – start with [php-ai/php-ml](https://gitlab.com/php-ai/php-ml) and [RubixML/RubixML](https://github.com/RubixML/RubixML) ⭐ 2,204 | 🐛 66 | 🌐 PHP | 📅 2026-08-26.
* **RAG (Retrieval-Augmented Generation)** – combine [php-rag](https://github.com/mzarnecki/php-rag) ⭐ 67 | 🐛 0 | 🌐 PHP | 📅 2026-07-19 with vector databases like [pgvector](https://github.com/pgvector/pgvector) ⭐ 22,749 | 🐛 14 | 🌐 C | 📅 2026-08-20 or [Meilisearch](https://github.com/meilisearch/meilisearch-php) ⭐ 758 | 🐛 62 | 🌐 PHP | 📅 2026-08-26.
...
* **I want to build a Laravel RAG app**\
  Use an LLM client like 🌟 [openai-php/client](https://github.com/openai-php/client) ⭐ 5,829 | 🐛 27 | 🌐 PHP | 📅 2026-08-18, embeddings + vector search via 🌟 [LLPhant/LLPhant](https://github.com/LLPhant/LLPhant) ⭐ 1,708 | 🐛 36 | 🌐 PHP | 📅 2026-07-26 with 🌟 [pgvector/pgvector](https://github.com/pgvector/pgvector) ⭐ 22,749 | 🐛 14 | 🌐 C | 📅 2026-08-20 or 🌟 [meilisearch/meilisearch-php](https://github.com/meilisearch/meilisearch-php) ⭐ 758 | 🐛 62 | 🌐 PHP | 📅 2026-08-26, and orchestrate agents/RAG flows with 🌟 [neuron-core/neuron-ai](https://github.com/neuron-core/neuron-ai) ⭐ 2,061 | 🐛 7 | 🌐 PHP | 📅 2026-08-20, integrating into Laravel using 🌟 [openai-php/laravel](https://github.com/openai-php/laravel) ⭐ 3,751 | 🐛 13 | 🌐 PHP | 📅 2026-07-27 and the packages under [Laravel & Framework Integrations](#laravel--framework-integrations).

* **I only need translation or vision**\
  For translation, see 🌟 [deepl-php](https://github.com/DeepLcom/deepl-php) ⭐ 257 | 🐛 27 | 🌐 PHP | 📅 2026-08-26 and 🌟 [googleapis/google-cloud-php](https://github.com/googleapis/google-cloud-php) ⭐ 1,181 | 🐛 77 | 🌐 PHP | 📅 2026-08-26 under [Interop & Model Serving](#interop--model-serving). For image/vision workloads, combine [Computer Vision, Image & Video Processing](#computer-vision-image--video-processing) libraries with cloud AI services via 🌟 [symfony/ai](https://github.com/symfony/ai) ⭐ 1,186 | 🐛 169 | 🌐 PHP | 📅 2026-08-25 or [openai-php/client](https://github.com/openai-php/client) ⭐ 5,829 | 🐛 27 | 🌐 PHP | 📅 2026-08-18 from [LLMs & AI APIs](#llms--ai-apis).

### Recommended core stack

These are opinionated defaults you can reach for when you just want something that works in production.

* **LLM clients:** 🌟 [openai-php/client](https://github.com/openai-php/client) ⭐ 5,829 | 🐛 27 | 🌐 PHP | 📅 2026-08-18 and 🌟 [google-gemini-php/client](https://github.com/google-gemini-php/client) ⭐ 409 | 🐛 8 | 🌐 PHP | 📅 2025-12-29 for major model providers.
* **General ML:** 🌟 [RubixML/RubixML](https://github.com/RubixML/RubixML) ⭐ 2,204 | 🐛 66 | 🌐 PHP | 📅 2026-08-26 for end-to-end ML pipelines.
* **Embeddings & vector search:** 🌟 [LLPhant/LLPhant](https://github.com/LLPhant/LLPhant) ⭐ 1,708 | 🐛 36 | 🌐 PHP | 📅 2026-07-26 with 🌟 [pgvector/pgvector](https://github.com/pgvector/pgvector) ⭐ 22,749 | 🐛 14 | 🌐 C | 📅 2026-08-20, 🌟 [pgvector/pgvector-php](https://github.com/pgvector/pgvector-php) ⭐ 197 | 🐛 0 | 🌐 PHP | 📅 2026-07-09, 🌟 [meilisearch/meilisearch-php](https://github.com/meilisearch/meilisearch-php) ⭐ 758 | 🐛 62 | 🌐 PHP | 📅 2026-08-26 or 🌟 [algolia/algoliasearch-client-php](https://github.com/algolia/algoliasearch-client-php) ⭐ 697 | 🐛 20 | 🌐 PHP | 📅 2026-08-25.
* **Data processing:** 🌟 [flow-php/flow](https://github.com/flow-php/flow) ⭐ 866 | 🐛 41 | 🌐 PHP | 📅 2026-08-26 for typed ETL-style pipelines.
* **Interop with Python ML:** 🌟 [swoole/phpy](https://github.com/swoole/phpy) ⭐ 652 | 🐛 3 | 🌐 PHP | 📅 2026-08-19 to call into the Python ecosystem when needed.
...
* 🌟 [RubixML/RubixML](https://github.com/RubixML/RubixML "Link to resource") ⭐ 2,204 | 🐛 66 | 🌐 PHP | 📅 2026-08-26 – ![GitHub stars](https://img.shields.io/github/stars/RubixML/RubixML?style=social) High-level ML framework with pipelines and datasets
...
* 🌟 [Intervention/image](https://github.com/Intervention/image "Link to resource") ⭐ 14,365 | 🐛 22 | 🌐 PHP | 📅 2026-08-25 – ![GitHub stars](https://img.shields.io/github/stars/Intervention/image?style=social) Image manipulation library for CV preprocessing
...
* 🌟 [brick/math](https://github.com/brick/math "Link to resource") ⭐ 2,162 | 🐛 2 | 🌐 PHP | 📅 2026-08-25 – ![GitHub stars](https://img.shields.io/github/stars/brick/math?style=social) Arbitrary-precision arithmetic for PHP (BigInteger, BigDecimal, BigRational)
...
* 🌟 [swoole/phpy](https://github.com/swoole/phpy "Link to resource") ⭐ 652 | 🐛 3 | 🌐 PHP | 📅 2026-08-19 – ![GitHub stars](https://img.shields.io/github/stars/swoole/phpy?style=social) Bridge for calling Python from PHP via a runtime bridge
...
* 🌟 [openai-php/client](https://github.com/openai-php/client "Link to resource") ⭐ 5,829 | 🐛 27 | 🌐 PHP | 📅 2026-08-18 – ![GitHub stars](https://img.shields.io/github/stars/openai-php/client?style=social) Official OpenAI PHP client
...
* 🌟 [pgvector/pgvector](https://github.com/pgvector/pgvector "Link to resource") ⭐ 22,749 | 🐛 14 | 🌐 C | 📅 2026-08-20 – ![GitHub stars](https://img.shields.io/github/stars/pgvector/pgvector?style=social) Vector similarity search extension for PostgreSQL
...
* 🌟 [meilisearch/meilisearch-php](https://github.com/meilisearch/meilisearch-php "Link to resource") ⭐ 758 | 🐛 62 | 🌐 PHP | 📅 2026-08-26 – ![GitHub stars](https://img.shields.io/github/stars/meilisearch/meilisearch-php?style=social) Client for Meilisearch search engine
* 🌟 [algolia/algoliasearch-client-php](https://github.com/algolia/algoliasearch-client-php "Link to resource") ⭐ 697 | 🐛 20 | 🌐 PHP | 📅 2026-08-25 – ![GitHub stars](https://img.shields.io/github/stars/algolia/algoliasearch-client-php?style=social) Algolia search client
...
* [symfony/serializer](https://github.com/symfony/serializer "Link to resource") ⭐ 2,536 | 🐛 0 | 🌐 PHP | 📅 2026-08-26 – Data normalization & serialization
...
* 🌟 [flow-php/flow](https://github.com/flow-php/flow "Link to resource") ⭐ 866 | 🐛 41 | 🌐 PHP | 📅 2026-08-26 – ![GitHub stars](https://img.shields.io/github/stars/flow-php/flow?style=social) Data processing and ETL framework for PHP with typed pipelines
...
* [symfony/console](https://github.com/symfony/console "Link to resource") ⭐ 9,810 | 🐛 0 | 🌐 PHP | 📅 2026-08-25 – CLI applications
...
* [symfony/http-client](https://github.com/symfony/http-client "Link to resource") ⭐ 2,030 | 🐛 0 | 🌐 PHP | 📅 2026-08-25 – Robust HTTP client for AI APIs
...
* 🌟 [laravel/boost](https://github.com/laravel/boost "Link to resource") ⭐ 3,592 | 🐛 28 | 🌐 PHP | 📅 2026-08-25 – ![GitHub stars](https://img.shields.io/github/stars/laravel/boost?style=social) Official Laravel Boost: a development server and AI context provider that accelerates AI-assisted code generation by giving AI tools detailed insight into your Laravel app (MCP server, schema inspection, docs + guidelines)
* 🌟 [laravel/ai](https://github.com/laravel/ai "Link to resource") ⭐ 1,122 | 🐛 58 | 🌐 PHP | 📅 2026-08-26 – ![GitHub stars](https://img.shields.io/github/stars/laravel/ai?style=social) The Laravel AI SDK: a unified, expressive Laravel API for interacting with AI providers (LLMs, images, embeddings, agents, tools)
...
* [vizra-ai/vizra-adk](https://github.com/vizra-ai/vizra-adk "Link to resource") ⭐ 296 | 🐛 0 | 🌐 PHP | 📅 2026-08-24 – Laravel AI Agent Development Kit for building autonomous agents with tools, persistent memory, workflows, streaming, evaluations, tracing, and Prism-powered multi-model support
...
* 🌟 [laravel/scout](https://github.com/laravel/scout "Link to resource") ⭐ 1,677 | 🐛 8 | 🌐 PHP | 📅 2026-08-25 – ![GitHub stars](https://img.shields.io/github/stars/laravel/scout?style=social) – Search abstraction (useful for vector search)
...
* 🌟 [symfony/ai](https://github.com/symfony/ai) ⭐ 1,186 | 🐛 169 | 🌐 PHP | 📅 2026-08-25 – ![GitHub stars](https://img.shields.io/github/stars/symfony/ai?style=social "Link to resource") – Symfony AI: built-in AI components and bundles for Symfony apps
...
* [symfony/mcp-bundle](https://github.com/symfony/mcp-bundle "Link to resource") ⭐ 48 | 🐛 0 | 🌐 PHP | 📅 2026-08-24 – Symfony bundle for exposing MCP tools, prompts, and resources over HTTP or STDIO using the official MCP SDK
...
* [WordPress/php-ai-client](https://github.com/WordPress/php-ai-client "Link to resource") ⭐ 301 | 🐛 66 | 🌐 PHP | 📅 2026-08-26 – Provider-agnostic PHP AI SDK offering a unified API for interacting with multiple LLM providers (OpenAI, Anthropic, Gemini, etc.), supporting text, image, speech, streaming, and multimodal operations
...
* [Awesome PHP](https://github.com/ziadoz/awesome-php "Link to resource") ⭐ 32,669 | 🐛 85 | 📅 2026-07-13
...
* [tensorflow/tfjs](https://github.com/tensorflow/tfjs "Link to resource") ⭐ 19,132 | 🐛 381 | 🌐 TypeScript | 📅 2026-06-23 – JavaScript machine learning platform for training and running models in the browser or Node.js (TensorFlow\.js)
