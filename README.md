...
Inspired by [awesome-php](https://github.com/ziadoz/awesome-php) ⭐ 32,680 | 🐛 88 | 📅 2026-07-13 and the broader **Awesome** ecosystem.
...
* **Classic ML / traditional models** – start with [php-ai/php-ml](https://gitlab.com/php-ai/php-ml) and [RubixML/RubixML](https://github.com/RubixML/RubixML) ⭐ 2,205 | 🐛 62 | 🌐 PHP | 📅 2026-09-08.
* **RAG (Retrieval-Augmented Generation)** – combine [php-rag](https://github.com/mzarnecki/php-rag) ⭐ 67 | 🐛 0 | 🌐 PHP | 📅 2026-07-19 with vector databases like [pgvector](https://github.com/pgvector/pgvector) ⭐ 22,950 | 🐛 14 | 🌐 C | 📅 2026-09-08 or [Meilisearch](https://github.com/meilisearch/meilisearch-php) ⭐ 758 | 🐛 61 | 🌐 PHP | 📅 2026-09-01.
...
* **I want to build a Laravel RAG app**\
  Use an LLM client like 🌟 [openai-php/client](https://github.com/openai-php/client) ⭐ 5,828 | 🐛 27 | 🌐 PHP | 📅 2026-08-18, embeddings + vector search via 🌟 [LLPhant/LLPhant](https://github.com/LLPhant/LLPhant) ⭐ 1,708 | 🐛 36 | 🌐 PHP | 📅 2026-09-07 with 🌟 [pgvector/pgvector](https://github.com/pgvector/pgvector) ⭐ 22,950 | 🐛 14 | 🌐 C | 📅 2026-09-08 or 🌟 [meilisearch/meilisearch-php](https://github.com/meilisearch/meilisearch-php) ⭐ 758 | 🐛 61 | 🌐 PHP | 📅 2026-09-01, and orchestrate agents/RAG flows with 🌟 [neuron-core/neuron-ai](https://github.com/neuron-core/neuron-ai) ⭐ 2,091 | 🐛 10 | 🌐 PHP | 📅 2026-09-08, integrating into Laravel using 🌟 [openai-php/laravel](https://github.com/openai-php/laravel) ⭐ 3,751 | 🐛 13 | 🌐 PHP | 📅 2026-07-27 and the packages under [Laravel & Framework Integrations](#laravel--framework-integrations).

* **I only need translation or vision**\
  For translation, see 🌟 [deepl-php](https://github.com/DeepLcom/deepl-php) ⭐ 257 | 🐛 27 | 🌐 PHP | 📅 2026-08-26 and 🌟 [googleapis/google-cloud-php](https://github.com/googleapis/google-cloud-php) ⭐ 1,183 | 🐛 73 | 🌐 PHP | 📅 2026-09-08 under [Interop & Model Serving](#interop--model-serving). For image/vision workloads, combine [Computer Vision, Image & Video Processing](#computer-vision-image--video-processing) libraries with cloud AI services via 🌟 [symfony/ai](https://github.com/symfony/ai) ⭐ 1,196 | 🐛 163 | 🌐 PHP | 📅 2026-09-08 or [openai-php/client](https://github.com/openai-php/client) ⭐ 5,828 | 🐛 27 | 🌐 PHP | 📅 2026-08-18 from [LLMs & AI APIs](#llms--ai-apis).

### Recommended core stack

These are opinionated defaults you can reach for when you just want something that works in production.

* **LLM clients:** 🌟 [openai-php/client](https://github.com/openai-php/client) ⭐ 5,828 | 🐛 27 | 🌐 PHP | 📅 2026-08-18 and 🌟 [google-gemini-php/client](https://github.com/google-gemini-php/client) ⭐ 409 | 🐛 9 | 🌐 PHP | 📅 2025-12-29 for major model providers.
* **General ML:** 🌟 [RubixML/RubixML](https://github.com/RubixML/RubixML) ⭐ 2,205 | 🐛 62 | 🌐 PHP | 📅 2026-09-08 for end-to-end ML pipelines.
* **Embeddings & vector search:** 🌟 [LLPhant/LLPhant](https://github.com/LLPhant/LLPhant) ⭐ 1,708 | 🐛 36 | 🌐 PHP | 📅 2026-09-07 with 🌟 [pgvector/pgvector](https://github.com/pgvector/pgvector) ⭐ 22,950 | 🐛 14 | 🌐 C | 📅 2026-09-08, 🌟 [pgvector/pgvector-php](https://github.com/pgvector/pgvector-php) ⭐ 197 | 🐛 0 | 🌐 PHP | 📅 2026-07-09, 🌟 [meilisearch/meilisearch-php](https://github.com/meilisearch/meilisearch-php) ⭐ 758 | 🐛 61 | 🌐 PHP | 📅 2026-09-01 or 🌟 [algolia/algoliasearch-client-php](https://github.com/algolia/algoliasearch-client-php) ⭐ 697 | 🐛 20 | 🌐 PHP | 📅 2026-08-27.
...
* 🌟 [RubixML/RubixML](https://github.com/RubixML/RubixML "Link to resource") ⭐ 2,205 | 🐛 62 | 🌐 PHP | 📅 2026-09-08 – ![GitHub stars](https://img.shields.io/github/stars/RubixML/RubixML?style=social) High-level ML framework with pipelines and datasets
...
* 🌟 [brick/math](https://github.com/brick/math "Link to resource") ⭐ 2,162 | 🐛 0 | 🌐 PHP | 📅 2026-08-31 – ![GitHub stars](https://img.shields.io/github/stars/brick/math?style=social) Arbitrary-precision arithmetic for PHP (BigInteger, BigDecimal, BigRational)
...
* [aimeos/prisma](https://github.com/aimeos/prisma "Link to resource") ⭐ 224 | 🐛 1 | 🌐 PHP | 📅 2026-09-08 – ![GitHub stars](https://img.shields.io/github/stars/aimeos/prisma?style=social) Lightweight PHP package providing a unified interface for text, image, audio, and video AI providers
...
* 🌟 [pgvector/pgvector](https://github.com/pgvector/pgvector "Link to resource") ⭐ 22,950 | 🐛 14 | 🌐 C | 📅 2026-09-08 – ![GitHub stars](https://img.shields.io/github/stars/pgvector/pgvector?style=social) Vector similarity search extension for PostgreSQL
...
* 🌟 [meilisearch/meilisearch-php](https://github.com/meilisearch/meilisearch-php "Link to resource") ⭐ 758 | 🐛 61 | 🌐 PHP | 📅 2026-09-01 – ![GitHub stars](https://img.shields.io/github/stars/meilisearch/meilisearch-php?style=social) Client for Meilisearch search engine
...
* 🌟 [neuron-core/neuron-ai](https://github.com/neuron-core/neuron-ai "Link to resource") ⭐ 2,091 | 🐛 10 | 🌐 PHP | 📅 2026-09-08 – ![GitHub stars](https://img.shields.io/github/stars/neuron-core/neuron-ai?style=social) PHP agentic AI framework for building and orchestrating LLMs, RAG etc
* 🌟 [googleapis/google-cloud-php](https://github.com/googleapis/google-cloud-php "Link to resource") ⭐ 1,183 | 🐛 73 | 🌐 PHP | 📅 2026-09-08 – ![GitHub stars](https://img.shields.io/github/stars/googleapis/google-cloud-php?style=social) Official PHP client library for Google Cloud APIs (including ML/AI services like Vision, Translate, AutoML, Vertex AI, etc.)
...
* [symfony/console](https://github.com/symfony/console "Link to resource") ⭐ 9,810 | 🐛 0 | 🌐 PHP | 📅 2026-09-08 – CLI applications
...
* 🌟 [laravel/boost](https://github.com/laravel/boost "Link to resource") ⭐ 3,611 | 🐛 23 | 🌐 PHP | 📅 2026-09-08 – ![GitHub stars](https://img.shields.io/github/stars/laravel/boost?style=social) Official Laravel Boost: a development server and AI context provider that accelerates AI-assisted code generation by giving AI tools detailed insight into your Laravel app (MCP server, schema inspection, docs + guidelines)
* 🌟 [laravel/ai](https://github.com/laravel/ai "Link to resource") ⭐ 1,145 | 🐛 54 | 🌐 PHP | 📅 2026-09-08 – ![GitHub stars](https://img.shields.io/github/stars/laravel/ai?style=social) The Laravel AI SDK: a unified, expressive Laravel API for interacting with AI providers (LLMs, images, embeddings, agents, tools)
...
* [spatie/laravel-data](https://github.com/spatie/laravel-data "Link to resource") ⭐ 1,790 | 🐛 14 | 🌐 PHP | 📅 2026-09-01 – Typed DTOs for API & AI responses
...
* 🌟 [laravel/scout](https://github.com/laravel/scout "Link to resource") ⭐ 1,676 | 🐛 7 | 🌐 PHP | 📅 2026-09-02 – ![GitHub stars](https://img.shields.io/github/stars/laravel/scout?style=social) – Search abstraction (useful for vector search)
...
* 🌟 [symfony/ai](https://github.com/symfony/ai) ⭐ 1,196 | 🐛 163 | 🌐 PHP | 📅 2026-09-08 – ![GitHub stars](https://img.shields.io/github/stars/symfony/ai?style=social "Link to resource") – Symfony AI: built-in AI components and bundles for Symfony apps
...
* [Awesome PHP](https://github.com/ziadoz/awesome-php "Link to resource") ⭐ 32,680 | 🐛 88 | 📅 2026-07-13
