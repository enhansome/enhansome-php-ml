...
Inspired by [awesome-php](https://github.com/ziadoz/awesome-php) ⭐ 32,704 | 🐛 92 | 📅 2026-07-13 and the broader **Awesome** ecosystem.
...
* **Classic ML / traditional models** – start with [php-ai/php-ml](https://gitlab.com/php-ai/php-ml) and [RubixML/RubixML](https://github.com/RubixML/RubixML) ⭐ 2,207 | 🐛 66 | 🌐 PHP | 📅 2026-09-20.
* **RAG (Retrieval-Augmented Generation)** – combine [php-rag](https://github.com/mzarnecki/php-rag) ⭐ 67 | 🐛 0 | 🌐 PHP | 📅 2026-07-19 with vector databases like [pgvector](https://github.com/pgvector/pgvector) ⭐ 23,121 | 🐛 17 | 🌐 C | 📅 2026-09-10 or [Meilisearch](https://github.com/meilisearch/meilisearch-php) ⭐ 757 | 🐛 63 | 🌐 PHP | 📅 2026-09-22.
...
* **I want to build a Laravel RAG app**\
  Use an LLM client like 🌟 [openai-php/client](https://github.com/openai-php/client) ⭐ 5,832 | 🐛 25 | 🌐 PHP | 📅 2026-09-22, embeddings + vector search via 🌟 [LLPhant/LLPhant](https://github.com/LLPhant/LLPhant) ⭐ 1,709 | 🐛 37 | 🌐 PHP | 📅 2026-09-07 with 🌟 [pgvector/pgvector](https://github.com/pgvector/pgvector) ⭐ 23,121 | 🐛 17 | 🌐 C | 📅 2026-09-10 or 🌟 [meilisearch/meilisearch-php](https://github.com/meilisearch/meilisearch-php) ⭐ 757 | 🐛 63 | 🌐 PHP | 📅 2026-09-22, and orchestrate agents/RAG flows with 🌟 [neuron-core/neuron-ai](https://github.com/neuron-core/neuron-ai) ⭐ 2,103 | 🐛 6 | 🌐 PHP | 📅 2026-09-21, integrating into Laravel using 🌟 [openai-php/laravel](https://github.com/openai-php/laravel) ⭐ 3,755 | 🐛 13 | 🌐 PHP | 📅 2026-09-17 and the packages under [Laravel & Framework Integrations](#laravel--framework-integrations).

* **I only need translation or vision**\
  For translation, see 🌟 [deepl-php](https://github.com/DeepLcom/deepl-php) ⭐ 260 | 🐛 29 | 🌐 PHP | 📅 2026-08-26 and 🌟 [googleapis/google-cloud-php](https://github.com/googleapis/google-cloud-php) ⭐ 1,182 | 🐛 73 | 🌐 PHP | 📅 2026-09-21 under [Interop & Model Serving](#interop--model-serving). For image/vision workloads, combine [Computer Vision, Image & Video Processing](#computer-vision-image--video-processing) libraries with cloud AI services via 🌟 [symfony/ai](https://github.com/symfony/ai) ⭐ 1,208 | 🐛 149 | 🌐 PHP | 📅 2026-09-21 or [openai-php/client](https://github.com/openai-php/client) ⭐ 5,832 | 🐛 25 | 🌐 PHP | 📅 2026-09-22 from [LLMs & AI APIs](#llms--ai-apis).

### Recommended core stack

These are opinionated defaults you can reach for when you just want something that works in production.

* **LLM clients:** 🌟 [openai-php/client](https://github.com/openai-php/client) ⭐ 5,832 | 🐛 25 | 🌐 PHP | 📅 2026-09-22 and 🌟 [google-gemini-php/client](https://github.com/google-gemini-php/client) ⭐ 411 | 🐛 10 | 🌐 PHP | 📅 2025-12-29 for major model providers.
* **General ML:** 🌟 [RubixML/RubixML](https://github.com/RubixML/RubixML) ⭐ 2,207 | 🐛 66 | 🌐 PHP | 📅 2026-09-20 for end-to-end ML pipelines.
* **Embeddings & vector search:** 🌟 [LLPhant/LLPhant](https://github.com/LLPhant/LLPhant) ⭐ 1,709 | 🐛 37 | 🌐 PHP | 📅 2026-09-07 with 🌟 [pgvector/pgvector](https://github.com/pgvector/pgvector) ⭐ 23,121 | 🐛 17 | 🌐 C | 📅 2026-09-10, 🌟 [pgvector/pgvector-php](https://github.com/pgvector/pgvector-php) ⭐ 197 | 🐛 0 | 🌐 PHP | 📅 2026-07-09, 🌟 [meilisearch/meilisearch-php](https://github.com/meilisearch/meilisearch-php) ⭐ 757 | 🐛 63 | 🌐 PHP | 📅 2026-09-22 or 🌟 [algolia/algoliasearch-client-php](https://github.com/algolia/algoliasearch-client-php) ⭐ 697 | 🐛 21 | 🌐 PHP | 📅 2026-09-21.
* **Data processing:** 🌟 [flow-php/flow](https://github.com/flow-php/flow) ⭐ 868 | 🐛 38 | 🌐 PHP | 📅 2026-09-22 for typed ETL-style pipelines.
...
* 🌟 [RubixML/RubixML](https://github.com/RubixML/RubixML "Link to resource") ⭐ 2,207 | 🐛 66 | 🌐 PHP | 📅 2026-09-20 – ![GitHub stars](https://img.shields.io/github/stars/RubixML/RubixML?style=social) High-level ML framework with pipelines and datasets
...
* 🌟 [Intervention/image](https://github.com/Intervention/image "Link to resource") ⭐ 14,371 | 🐛 24 | 🌐 PHP | 📅 2026-09-22 – ![GitHub stars](https://img.shields.io/github/stars/Intervention/image?style=social) Image manipulation library for CV preprocessing
...
* 🧪 [mailmug/php-dlib](https://github.com/mailmug/php-dlib "Link to resource") ⭐ 13 | 🐛 0 | 🌐 C++ | 📅 2026-09-22 – PHP extension for Dlib, supporting face detection, facial landmarks, face recognition descriptors, CNN detection, and clustering
...
* 🌟 [openai-php/client](https://github.com/openai-php/client "Link to resource") ⭐ 5,832 | 🐛 25 | 🌐 PHP | 📅 2026-09-22 – ![GitHub stars](https://img.shields.io/github/stars/openai-php/client?style=social) Official OpenAI PHP client
* 🌟 [dtyq/magic](https://github.com/dtyq/magic "Link to resource") ⭐ 5,039 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-12 – ![GitHub stars](https://img.shields.io/github/stars/dtyq/magic?style=social) Open-source enterprise AI agent platform with generalist agents, workflow orchestration, IM integration, collaborative office features, and support for multiple LLMs
...
* [aimeos/prisma](https://github.com/aimeos/prisma "Link to resource") ⭐ 229 | 🐛 1 | 🌐 PHP | 📅 2026-09-21 – ![GitHub stars](https://img.shields.io/github/stars/aimeos/prisma?style=social) Lightweight PHP package providing a unified interface for text, image, audio, and video AI providers
...
* [aiaccess/ai-access](https://github.com/aiaccess/ai-access "Link to resource") ⭐ 63 | 🐛 0 | 🌐 PHP | 📅 2026-08-26 – Unified PHP AI client providing a consistent interface for multiple providers (OpenAI, Anthropic, Gemini, DeepSeek, Grok) with support for chat, embeddings, batch processing, and provider switching
* [mozex/anthropic-php](https://github.com/mozex/anthropic-php "Link to resource") ⭐ 47 | 🐛 0 | 🌐 PHP | 📅 2026-09-13 – Community-maintained PHP API client for the Anthropic (Claude) AI API, supporting messages, streaming, tool use, and batch processing
...
* [utopia-php/agents](https://github.com/utopia-php/agents "Link to resource") ⭐ 10 | 🐛 2 | 🌐 PHP | 📅 2026-09-21 – Simple, lightweight PHP library for AI agent orchestration with multi-provider support (OpenAI, Anthropic, Deepseek, Perplexity, XAI)
...
* 🧪 [carmelosantana/php-agents](https://github.com/carmelosantana/php-agents) ⭐ 1 | 🐛 0 | 🌐 PHP | 📅 2026-09-22 – PHP framework for building AI agents with tool use, provider abstraction and multi-model support
...
* 🌟 [pgvector/pgvector](https://github.com/pgvector/pgvector "Link to resource") ⭐ 23,121 | 🐛 17 | 🌐 C | 📅 2026-09-10 – ![GitHub stars](https://img.shields.io/github/stars/pgvector/pgvector?style=social) Vector similarity search extension for PostgreSQL
* 🌟 [LLPhant/LLPhant](https://github.com/LLPhant/LLPhant "Link to resource") ⭐ 1,709 | 🐛 37 | 🌐 PHP | 📅 2026-09-07 – ![GitHub stars](https://img.shields.io/github/stars/LLPhant/LLPhant?style=social) Comprehensive PHP generative AI framework supporting LLMs, embeddings, vector search and more
* 🌟 [meilisearch/meilisearch-php](https://github.com/meilisearch/meilisearch-php "Link to resource") ⭐ 757 | 🐛 63 | 🌐 PHP | 📅 2026-09-22 – ![GitHub stars](https://img.shields.io/github/stars/meilisearch/meilisearch-php?style=social) Client for Meilisearch search engine
* 🌟 [algolia/algoliasearch-client-php](https://github.com/algolia/algoliasearch-client-php "Link to resource") ⭐ 697 | 🐛 21 | 🌐 PHP | 📅 2026-09-21 – ![GitHub stars](https://img.shields.io/github/stars/algolia/algoliasearch-client-php?style=social) Algolia search client
...
* 🌟 [flow-php/flow](https://github.com/flow-php/flow "Link to resource") ⭐ 868 | 🐛 38 | 🌐 PHP | 📅 2026-09-22 – ![GitHub stars](https://img.shields.io/github/stars/flow-php/flow?style=social) Data processing and ETL framework for PHP with typed pipelines
...
* 🌟 [neuron-core/neuron-ai](https://github.com/neuron-core/neuron-ai "Link to resource") ⭐ 2,103 | 🐛 6 | 🌐 PHP | 📅 2026-09-21 – ![GitHub stars](https://img.shields.io/github/stars/neuron-core/neuron-ai?style=social) PHP agentic AI framework for building and orchestrating LLMs, RAG etc
* 🌟 [googleapis/google-cloud-php](https://github.com/googleapis/google-cloud-php "Link to resource") ⭐ 1,182 | 🐛 73 | 🌐 PHP | 📅 2026-09-21 – ![GitHub stars](https://img.shields.io/github/stars/googleapis/google-cloud-php?style=social) Official PHP client library for Google Cloud APIs (including ML/AI services like Vision, Translate, AutoML, Vertex AI, etc.)
...
* [symfony/console](https://github.com/symfony/console "Link to resource") ⭐ 9,813 | 🐛 0 | 🌐 PHP | 📅 2026-09-18 – CLI applications
...
* 🌟 [openai-php/laravel](https://github.com/openai-php/laravel "Link to resource") ⭐ 3,755 | 🐛 13 | 🌐 PHP | 📅 2026-09-17 – ![GitHub stars](https://img.shields.io/github/stars/openai-php/laravel?style=social) Laravel OpenAI integration
* 🌟 [laravel/boost](https://github.com/laravel/boost "Link to resource") ⭐ 3,626 | 🐛 13 | 🌐 PHP | 📅 2026-09-22 – ![GitHub stars](https://img.shields.io/github/stars/laravel/boost?style=social) Official Laravel Boost: a development server and AI context provider that accelerates AI-assisted code generation by giving AI tools detailed insight into your Laravel app (MCP server, schema inspection, docs + guidelines)
* 🌟 [laravel/ai](https://github.com/laravel/ai "Link to resource") ⭐ 1,184 | 🐛 25 | 🌐 PHP | 📅 2026-09-22 – ![GitHub stars](https://img.shields.io/github/stars/laravel/ai?style=social) The Laravel AI SDK: a unified, expressive Laravel API for interacting with AI providers (LLMs, images, embeddings, agents, tools)
...
* 🧪 [builtbyberry/laravel-swarm](https://github.com/builtbyberry/laravel-swarm "Link to resource") ⭐ 35 | 🐛 32 | 🌐 PHP | 📅 2026-09-22 – Multi-agent swarm orchestration for Laravel, built on Laravel AI, with sequential, parallel, hierarchical, queued, streamed, and durable workflows
...
* [spatie/laravel-data](https://github.com/spatie/laravel-data "Link to resource") ⭐ 1,794 | 🐛 18 | 🌐 PHP | 📅 2026-09-01 – Typed DTOs for API & AI responses
...
* 🌟 [laravel/scout](https://github.com/laravel/scout "Link to resource") ⭐ 1,677 | 🐛 7 | 🌐 PHP | 📅 2026-09-22 – ![GitHub stars](https://img.shields.io/github/stars/laravel/scout?style=social) – Search abstraction (useful for vector search)
...
* 🌟 [symfony/ai](https://github.com/symfony/ai) ⭐ 1,208 | 🐛 149 | 🌐 PHP | 📅 2026-09-21 – ![GitHub stars](https://img.shields.io/github/stars/symfony/ai?style=social "Link to resource") – Symfony AI: built-in AI components and bundles for Symfony apps
...
* 🧪 [symfony/ai-platform](https://github.com/symfony/ai-platform "Link to resource") ⭐ 54 | 🐛 0 | 🌐 PHP | 📅 2026-09-21 – Experimental Symfony AI Platform component providing a unified abstraction for interacting with AI models, providers, messages, embeddings, speech, and provider-specific bridge packages
...
* 🧪 [symfony/ai-bundle](https://github.com/symfony/ai-bundle "Link to resource") ⭐ 32 | 🐛 0 | 🌐 PHP | 📅 2026-09-21 – Symfony integration bundle that brings together Symfony AI components for agents, chat, platforms, stores, RAG, tools, and configuration
...
* [Awesome PHP](https://github.com/ziadoz/awesome-php "Link to resource") ⭐ 32,704 | 🐛 92 | 📅 2026-07-13
...
* [tensorflow/tfjs](https://github.com/tensorflow/tfjs "Link to resource") ⭐ 19,142 | 🐛 383 | 🌐 TypeScript | 📅 2026-06-23 – JavaScript machine learning platform for training and running models in the browser or Node.js (TensorFlow\.js)
