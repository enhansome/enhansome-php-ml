...
Inspired by [awesome-php](https://github.com/ziadoz/awesome-php) ⭐ 32,698 | 🐛 91 | 📅 2026-07-13 and the broader **Awesome** ecosystem.
...
* **Classic ML / traditional models** – start with [php-ai/php-ml](https://gitlab.com/php-ai/php-ml) and [RubixML/RubixML](https://github.com/RubixML/RubixML) ⭐ 2,204 | 🐛 64 | 🌐 PHP | 📅 2026-09-14.
* **RAG (Retrieval-Augmented Generation)** – combine [php-rag](https://github.com/mzarnecki/php-rag) ⭐ 67 | 🐛 0 | 🌐 PHP | 📅 2026-07-19 with vector databases like [pgvector](https://github.com/pgvector/pgvector) ⭐ 23,011 | 🐛 18 | 🌐 C | 📅 2026-09-10 or [Meilisearch](https://github.com/meilisearch/meilisearch-php) ⭐ 757 | 🐛 60 | 🌐 PHP | 📅 2026-09-09.
...
* **Data processing:** 🌟 [flow-php/flow](https://github.com/flow-php/flow) ⭐ 867 | 🐛 34 | 🌐 PHP | 📅 2026-09-14 for typed ETL-style pipelines.
...
* 🌟 [RubixML/RubixML](https://github.com/RubixML/RubixML "Link to resource") ⭐ 2,204 | 🐛 64 | 🌐 PHP | 📅 2026-09-14 – ![GitHub stars](https://img.shields.io/github/stars/RubixML/RubixML?style=social) High-level ML framework with pipelines and datasets
...
* [davmixcool/php-sentiment-analyzer](https://github.com/davmixcool/php-sentiment-analyzer "Link to resource") ⭐ 134 | 🐛 0 | 🌐 PHP | 📅 2026-08-20 – Lightweight PHP library for sentiment analysis using lexical rules
...
* 🌟 [brick/math](https://github.com/brick/math "Link to resource") ⭐ 2,173 | 🐛 0 | 🌐 PHP | 📅 2026-09-12 – ![GitHub stars](https://img.shields.io/github/stars/brick/math?style=social) Arbitrary-precision arithmetic for PHP (BigInteger, BigDecimal, BigRational)
...
* 🌟 [ankane/onnxruntime-php](https://github.com/ankane/onnxruntime-php "Link to resource") ⭐ 151 | 🐛 1 | 🌐 PHP | 📅 2026-09-10 – ![GitHub stars](https://img.shields.io/github/stars/ankane/onnxruntime-php?style=social) Run ONNX models from PHP
...
* 🌟 [openai-php/client](https://github.com/openai-php/client "Link to resource") ⭐ 5,830 | 🐛 27 | 🌐 PHP | 📅 2026-09-11 – ![GitHub stars](https://img.shields.io/github/stars/openai-php/client?style=social) Official OpenAI PHP client
* 🌟 [dtyq/magic](https://github.com/dtyq/magic "Link to resource") ⭐ 5,026 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-12 – ![GitHub stars](https://img.shields.io/github/stars/dtyq/magic?style=social) Open-source enterprise AI agent platform with generalist agents, workflow orchestration, IM integration, collaborative office features, and support for multiple LLMs
...
* 🌟 [pgvector/pgvector](https://github.com/pgvector/pgvector "Link to resource") ⭐ 23,011 | 🐛 18 | 🌐 C | 📅 2026-09-10 – ![GitHub stars](https://img.shields.io/github/stars/pgvector/pgvector?style=social) Vector similarity search extension for PostgreSQL
...
* 🌟 [algolia/algoliasearch-client-php](https://github.com/algolia/algoliasearch-client-php "Link to resource") ⭐ 697 | 🐛 21 | 🌐 PHP | 📅 2026-09-14 – ![GitHub stars](https://img.shields.io/github/stars/algolia/algoliasearch-client-php?style=social) Algolia search client
...
* [league/csv](https://github.com/thephpleague/csv "Link to resource") ⭐ 3,483 | 🐛 2 | 🌐 PHP | 📅 2026-09-06 – CSV data processing
...
* [symfony/serializer](https://github.com/symfony/serializer "Link to resource") ⭐ 2,536 | 🐛 0 | 🌐 PHP | 📅 2026-09-11 – Data normalization & serialization
...
* 🌟 [flow-php/flow](https://github.com/flow-php/flow "Link to resource") ⭐ 867 | 🐛 34 | 🌐 PHP | 📅 2026-09-14 – ![GitHub stars](https://img.shields.io/github/stars/flow-php/flow?style=social) Data processing and ETL framework for PHP with typed pipelines
...
* 🌟 [neuron-core/neuron-ai](https://github.com/neuron-core/neuron-ai "Link to resource") ⭐ 2,093 | 🐛 5 | 🌐 PHP | 📅 2026-09-14 – ![GitHub stars](https://img.shields.io/github/stars/neuron-core/neuron-ai?style=social) PHP agentic AI framework for building and orchestrating LLMs, RAG etc
* 🌟 [googleapis/google-cloud-php](https://github.com/googleapis/google-cloud-php "Link to resource") ⭐ 1,182 | 🐛 73 | 🌐 PHP | 📅 2026-09-11 – ![GitHub stars](https://img.shields.io/github/stars/googleapis/google-cloud-php?style=social) Official PHP client library for Google Cloud APIs (including ML/AI services like Vision, Translate, AutoML, Vertex AI, etc.)
...
* [symfony/console](https://github.com/symfony/console "Link to resource") ⭐ 9,812 | 🐛 0 | 🌐 PHP | 📅 2026-09-13 – CLI applications
...
* [symfony/http-client](https://github.com/symfony/http-client "Link to resource") ⭐ 2,029 | 🐛 0 | 🌐 PHP | 📅 2026-09-10 – Robust HTTP client for AI APIs
* [guanguans/ai-commit](https://github.com/guanguans/ai-commit "Link to resource") ⭐ 394 | 🐛 0 | 🌐 PHP | 📅 2026-09-12 – AI-powered CLI to automatically generate conventional Git commit messages
...
* 🌟 [laravel/boost](https://github.com/laravel/boost "Link to resource") ⭐ 3,616 | 🐛 17 | 🌐 PHP | 📅 2026-09-14 – ![GitHub stars](https://img.shields.io/github/stars/laravel/boost?style=social) Official Laravel Boost: a development server and AI context provider that accelerates AI-assisted code generation by giving AI tools detailed insight into your Laravel app (MCP server, schema inspection, docs + guidelines)
* 🌟 [laravel/ai](https://github.com/laravel/ai "Link to resource") ⭐ 1,159 | 🐛 43 | 🌐 PHP | 📅 2026-09-11 – ![GitHub stars](https://img.shields.io/github/stars/laravel/ai?style=social) The Laravel AI SDK: a unified, expressive Laravel API for interacting with AI providers (LLMs, images, embeddings, agents, tools)
* [maestroerror/LarAgent](https://github.com/maestroerror/LarAgent "Link to resource") ⭐ 643 | 🐛 7 | 🌐 PHP | 📅 2026-08-20 – AI agent development framework for Laravel: define agents, tools, workflows, and manage LLM interactions with an Eloquent-style API
...
* 🌟 [symfony/ai](https://github.com/symfony/ai) ⭐ 1,203 | 🐛 171 | 🌐 PHP | 📅 2026-09-14 – ![GitHub stars](https://img.shields.io/github/stars/symfony/ai?style=social "Link to resource") – Symfony AI: built-in AI components and bundles for Symfony apps
...
* 🧪 [symfony/ai-platform](https://github.com/symfony/ai-platform "Link to resource") ⭐ 54 | 🐛 0 | 🌐 PHP | 📅 2026-09-13 – Experimental Symfony AI Platform component providing a unified abstraction for interacting with AI models, providers, messages, embeddings, speech, and provider-specific bridge packages
...
* 🧪 [symfony/ai-agent](https://github.com/symfony/ai-agent "Link to resource") ⭐ 32 | 🐛 0 | 🌐 PHP | 📅 2026-09-06 – Symfony AI Agent component for building agentic applications that interact with users, execute tasks, and manage workflows
...
* [Awesome PHP](https://github.com/ziadoz/awesome-php "Link to resource") ⭐ 32,698 | 🐛 91 | 📅 2026-07-13
* 🧪 [dykyi-roman/awesome-claude-code](https://github.com/dykyi-roman/awesome-claude-code "Link to resource") ⭐ 97 | 🐛 0 | 🌐 Python | 📅 2026-08-16 – Curated collection of commands, agents, skills, hooks, and tools for enhancing Claude Code AI workflows
