...
* 🌟 [RubixML/RubixML](https://github.com/RubixML/RubixML "Link to resource") ⭐ 2,204 | 🐛 60 | 🌐 PHP | 📅 2026-09-04 – ![GitHub stars](https://img.shields.io/github/stars/RubixML/RubixML?style=social) High-level ML framework with pipelines and datasets
...
* [HelgeSverre/toon-php](https://github.com/HelgeSverre/toon-php "Link to resource") ⭐ 130 | 🐛 1 | 🌐 PHP | 📅 2026-07-08 – PHP implementation of TOON, a compact data format for reducing token usage when sending structured data to LLMs
...
* [league/csv](https://github.com/thephpleague/csv "Link to resource") ⭐ 3,482 | 🐛 2 | 🌐 PHP | 📅 2026-09-03 – CSV data processing
