...
* **RAG (Retrieval-Augmented Generation)** – combine [php-rag](https://github.com/mzarnecki/php-rag) ⭐ 67 | 🐛 0 | 🌐 PHP | 📅 2026-07-19 with vector databases like [pgvector](https://github.com/pgvector/pgvector) ⭐ 22,650 | 🐛 14 | 🌐 C | 📅 2026-08-15 or [Meilisearch](https://github.com/meilisearch/meilisearch-php) ⭐ 756 | 🐛 61 | 🌐 PHP | 📅 2026-08-11.
...
* 🌟 [Intervention/image](https://github.com/Intervention/image "Link to resource") ⭐ 14,368 | 🐛 21 | 🌐 PHP | 📅 2026-08-16 – ![GitHub stars](https://img.shields.io/github/stars/Intervention/image?style=social) Image manipulation library for CV preprocessing
* 🧪 [aschmelyun/subvert](https://github.com/aschmelyun/subvert "Link to resource") ⭐ 869 | 🐛 26 | 🌐 PHP | 📅 2026-05-15 - Generate subtitles, summaries, and chapters from videos in seconds
...
* [aimeos/prisma](https://github.com/aimeos/prisma "Link to resource") ⭐ 215 | 🐛 2 | 🌐 PHP | 📅 2026-08-17 – ![GitHub stars](https://img.shields.io/github/stars/aimeos/prisma?style=social) Lightweight PHP package providing a unified interface for text, image, audio, and video AI providers
...
* [aiaccess/ai-access](https://github.com/aiaccess/ai-access "Link to resource") ⭐ 56 | 🐛 0 | 🌐 PHP | 📅 2026-08-16 – Unified PHP AI client providing a consistent interface for multiple providers (OpenAI, Anthropic, Gemini, DeepSeek, Grok) with support for chat, embeddings, batch processing, and provider switching
...
* 🌟 [pgvector/pgvector](https://github.com/pgvector/pgvector "Link to resource") ⭐ 22,650 | 🐛 14 | 🌐 C | 📅 2026-08-15 – ![GitHub stars](https://img.shields.io/github/stars/pgvector/pgvector?style=social) Vector similarity search extension for PostgreSQL
...
* [symfony/serializer](https://github.com/symfony/serializer "Link to resource") ⭐ 2,536 | 🐛 0 | 🌐 PHP | 📅 2026-08-17 – Data normalization & serialization
...
* 🌟 [flow-php/flow](https://github.com/flow-php/flow "Link to resource") ⭐ 866 | 🐛 36 | 🌐 PHP | 📅 2026-08-17 – ![GitHub stars](https://img.shields.io/github/stars/flow-php/flow?style=social) Data processing and ETL framework for PHP with typed pipelines
...
* 🌟 [neuron-core/neuron-ai](https://github.com/neuron-core/neuron-ai "Link to resource") ⭐ 2,054 | 🐛 8 | 🌐 PHP | 📅 2026-08-16 – ![GitHub stars](https://img.shields.io/github/stars/neuron-core/neuron-ai?style=social) PHP agentic AI framework for building and orchestrating LLMs, RAG etc
...
* [grpc/grpc-php](https://github.com/grpc/grpc-php "Link to resource") ⭐ 513 | 🐛 0 | 🌐 PHP | 📅 2026-07-24 – gRPC client for model services
...
* [symfony/console](https://github.com/symfony/console "Link to resource") ⭐ 9,808 | 🐛 0 | 🌐 PHP | 📅 2026-08-17 – CLI applications
...
* [symfony/http-client](https://github.com/symfony/http-client "Link to resource") ⭐ 2,029 | 🐛 0 | 🌐 PHP | 📅 2026-08-17 – Robust HTTP client for AI APIs
...
* 🌟 [laravel/boost](https://github.com/laravel/boost "Link to resource") ⭐ 3,579 | 🐛 22 | 🌐 PHP | 📅 2026-08-17 – ![GitHub stars](https://img.shields.io/github/stars/laravel/boost?style=social) Official Laravel Boost: a development server and AI context provider that accelerates AI-assisted code generation by giving AI tools detailed insight into your Laravel app (MCP server, schema inspection, docs + guidelines)
* 🌟 [laravel/ai](https://github.com/laravel/ai "Link to resource") ⭐ 1,102 | 🐛 47 | 🌐 PHP | 📅 2026-08-17 – ![GitHub stars](https://img.shields.io/github/stars/laravel/ai?style=social) The Laravel AI SDK: a unified, expressive Laravel API for interacting with AI providers (LLMs, images, embeddings, agents, tools)
...
* [vizra-ai/vizra-adk](https://github.com/vizra-ai/vizra-adk "Link to resource") ⭐ 297 | 🐛 2 | 🌐 PHP | 📅 2026-05-18 – Laravel AI Agent Development Kit for building autonomous agents with tools, persistent memory, workflows, streaming, evaluations, tracing, and Prism-powered multi-model support
...
* [RedberryProducts/mcp-client-laravel](https://github.com/RedberryProducts/mcp-client-laravel "Link to resource") ⭐ 13 | 🐛 4 | 🌐 PHP | 📅 2026-08-17 – Laravel-native MCP client for connecting to Model Context Protocol servers via HTTP or STDIO, retrieving tools and resources, and integrating external agent capabilities into Laravel apps
...
* 🌟 [symfony/ai](https://github.com/symfony/ai) ⭐ 1,180 | 🐛 181 | 🌐 PHP | 📅 2026-08-17 – ![GitHub stars](https://img.shields.io/github/stars/symfony/ai?style=social "Link to resource") – Symfony AI: built-in AI components and bundles for Symfony apps
...
* 🧪 [symfony/ai-platform](https://github.com/symfony/ai-platform "Link to resource") ⭐ 52 | 🐛 0 | 🌐 PHP | 📅 2026-08-17 – Experimental Symfony AI Platform component providing a unified abstraction for interacting with AI models, providers, messages, embeddings, speech, and provider-specific bridge packages
...
* 🧪 [symfony/ai-bundle](https://github.com/symfony/ai-bundle "Link to resource") ⭐ 31 | 🐛 0 | 🌐 PHP | 📅 2026-08-17 – Symfony integration bundle that brings together Symfony AI components for agents, chat, platforms, stores, RAG, tools, and configuration
