...
Inspired by [awesome-php](https://github.com/ziadoz/awesome-php) ⭐ 32,686 | 🐛 90 | 📅 2026-07-13 and the broader **Awesome** ecosystem.
...
* **Classic ML / traditional models** – start with [php-ai/php-ml](https://gitlab.com/php-ai/php-ml) and [RubixML/RubixML](https://github.com/RubixML/RubixML) ⭐ 2,204 | 🐛 62 | 🌐 PHP | 📅 2026-09-11.
* **RAG (Retrieval-Augmented Generation)** – combine [php-rag](https://github.com/mzarnecki/php-rag) ⭐ 67 | 🐛 0 | 🌐 PHP | 📅 2026-07-19 with vector databases like [pgvector](https://github.com/pgvector/pgvector) ⭐ 22,984 | 🐛 16 | 🌐 C | 📅 2026-09-10 or [Meilisearch](https://github.com/meilisearch/meilisearch-php) ⭐ 757 | 🐛 60 | 🌐 PHP | 📅 2026-09-09.
...
* **I want to build a Laravel RAG app**\
  Use an LLM client like 🌟 [openai-php/client](https://github.com/openai-php/client) ⭐ 5,829 | 🐛 28 | 🌐 PHP | 📅 2026-08-18, embeddings + vector search via 🌟 [LLPhant/LLPhant](https://github.com/LLPhant/LLPhant) ⭐ 1,707 | 🐛 36 | 🌐 PHP | 📅 2026-09-07 with 🌟 [pgvector/pgvector](https://github.com/pgvector/pgvector) ⭐ 22,984 | 🐛 16 | 🌐 C | 📅 2026-09-10 or 🌟 [meilisearch/meilisearch-php](https://github.com/meilisearch/meilisearch-php) ⭐ 757 | 🐛 60 | 🌐 PHP | 📅 2026-09-09, and orchestrate agents/RAG flows with 🌟 [neuron-core/neuron-ai](https://github.com/neuron-core/neuron-ai) ⭐ 2,092 | 🐛 8 | 🌐 PHP | 📅 2026-09-11, integrating into Laravel using 🌟 [openai-php/laravel](https://github.com/openai-php/laravel) ⭐ 3,753 | 🐛 13 | 🌐 PHP | 📅 2026-07-27 and the packages under [Laravel & Framework Integrations](#laravel--framework-integrations).

* **I only need translation or vision**\
  For translation, see 🌟 [deepl-php](https://github.com/DeepLcom/deepl-php) ⭐ 257 | 🐛 27 | 🌐 PHP | 📅 2026-08-26 and 🌟 [googleapis/google-cloud-php](https://github.com/googleapis/google-cloud-php) ⭐ 1,183 | 🐛 69 | 🌐 PHP | 📅 2026-09-10 under [Interop & Model Serving](#interop--model-serving). For image/vision workloads, combine [Computer Vision, Image & Video Processing](#computer-vision-image--video-processing) libraries with cloud AI services via 🌟 [symfony/ai](https://github.com/symfony/ai) ⭐ 1,196 | 🐛 165 | 🌐 PHP | 📅 2026-09-08 or [openai-php/client](https://github.com/openai-php/client) ⭐ 5,829 | 🐛 28 | 🌐 PHP | 📅 2026-08-18 from [LLMs & AI APIs](#llms--ai-apis).

### Recommended core stack

These are opinionated defaults you can reach for when you just want something that works in production.

* **LLM clients:** 🌟 [openai-php/client](https://github.com/openai-php/client) ⭐ 5,829 | 🐛 28 | 🌐 PHP | 📅 2026-08-18 and 🌟 [google-gemini-php/client](https://github.com/google-gemini-php/client) ⭐ 409 | 🐛 10 | 🌐 PHP | 📅 2025-12-29 for major model providers.
* **General ML:** 🌟 [RubixML/RubixML](https://github.com/RubixML/RubixML) ⭐ 2,204 | 🐛 62 | 🌐 PHP | 📅 2026-09-11 for end-to-end ML pipelines.
...
* **Data processing:** 🌟 [flow-php/flow](https://github.com/flow-php/flow) ⭐ 865 | 🐛 46 | 🌐 PHP | 📅 2026-09-11 for typed ETL-style pipelines.
...
* 🌟 [RubixML/RubixML](https://github.com/RubixML/RubixML "Link to resource") ⭐ 2,204 | 🐛 62 | 🌐 PHP | 📅 2026-09-11 – ![GitHub stars](https://img.shields.io/github/stars/RubixML/RubixML?style=social) High-level ML framework with pipelines and datasets
...
* 🌟 [Intervention/image](https://github.com/Intervention/image "Link to resource") ⭐ 14,370 | 🐛 22 | 🌐 PHP | 📅 2026-08-29 – ![GitHub stars](https://img.shields.io/github/stars/Intervention/image?style=social) Image manipulation library for CV preprocessing
...
* 🌟 [brick/math](https://github.com/brick/math "Link to resource") ⭐ 2,163 | 🐛 0 | 🌐 PHP | 📅 2026-09-10 – ![GitHub stars](https://img.shields.io/github/stars/brick/math?style=social) Arbitrary-precision arithmetic for PHP (BigInteger, BigDecimal, BigRational)
...
* 🌟 [openai-php/client](https://github.com/openai-php/client "Link to resource") ⭐ 5,829 | 🐛 28 | 🌐 PHP | 📅 2026-08-18 – ![GitHub stars](https://img.shields.io/github/stars/openai-php/client?style=social) Official OpenAI PHP client
...
* 🌟 [pgvector/pgvector](https://github.com/pgvector/pgvector "Link to resource") ⭐ 22,984 | 🐛 16 | 🌐 C | 📅 2026-09-10 – ![GitHub stars](https://img.shields.io/github/stars/pgvector/pgvector?style=social) Vector similarity search extension for PostgreSQL
...
* [symfony/serializer](https://github.com/symfony/serializer "Link to resource") ⭐ 2,536 | 🐛 0 | 🌐 PHP | 📅 2026-09-10 – Data normalization & serialization
...
* 🌟 [flow-php/flow](https://github.com/flow-php/flow "Link to resource") ⭐ 865 | 🐛 46 | 🌐 PHP | 📅 2026-09-11 – ![GitHub stars](https://img.shields.io/github/stars/flow-php/flow?style=social) Data processing and ETL framework for PHP with typed pipelines
...
* 🌟 [neuron-core/neuron-ai](https://github.com/neuron-core/neuron-ai "Link to resource") ⭐ 2,092 | 🐛 8 | 🌐 PHP | 📅 2026-09-11 – ![GitHub stars](https://img.shields.io/github/stars/neuron-core/neuron-ai?style=social) PHP agentic AI framework for building and orchestrating LLMs, RAG etc
* 🌟 [googleapis/google-cloud-php](https://github.com/googleapis/google-cloud-php "Link to resource") ⭐ 1,183 | 🐛 69 | 🌐 PHP | 📅 2026-09-10 – ![GitHub stars](https://img.shields.io/github/stars/googleapis/google-cloud-php?style=social) Official PHP client library for Google Cloud APIs (including ML/AI services like Vision, Translate, AutoML, Vertex AI, etc.)
...
* [symfony/console](https://github.com/symfony/console "Link to resource") ⭐ 9,812 | 🐛 0 | 🌐 PHP | 📅 2026-09-10 – CLI applications
...
* [guanguans/ai-commit](https://github.com/guanguans/ai-commit "Link to resource") ⭐ 394 | 🐛 0 | 🌐 PHP | 📅 2026-09-10 – AI-powered CLI to automatically generate conventional Git commit messages
...
* 🌟 [laravel/boost](https://github.com/laravel/boost "Link to resource") ⭐ 3,613 | 🐛 14 | 🌐 PHP | 📅 2026-09-11 – ![GitHub stars](https://img.shields.io/github/stars/laravel/boost?style=social) Official Laravel Boost: a development server and AI context provider that accelerates AI-assisted code generation by giving AI tools detailed insight into your Laravel app (MCP server, schema inspection, docs + guidelines)
* 🌟 [laravel/ai](https://github.com/laravel/ai "Link to resource") ⭐ 1,148 | 🐛 41 | 🌐 PHP | 📅 2026-09-10 – ![GitHub stars](https://img.shields.io/github/stars/laravel/ai?style=social) The Laravel AI SDK: a unified, expressive Laravel API for interacting with AI providers (LLMs, images, embeddings, agents, tools)
...
* [spatie/laravel-data](https://github.com/spatie/laravel-data "Link to resource") ⭐ 1,790 | 🐛 15 | 🌐 PHP | 📅 2026-09-01 – Typed DTOs for API & AI responses
...
* 🌟 [laravel/scout](https://github.com/laravel/scout "Link to resource") ⭐ 1,676 | 🐛 7 | 🌐 PHP | 📅 2026-09-08 – ![GitHub stars](https://img.shields.io/github/stars/laravel/scout?style=social) – Search abstraction (useful for vector search)
...
* 🌟 [symfony/ai](https://github.com/symfony/ai) ⭐ 1,196 | 🐛 165 | 🌐 PHP | 📅 2026-09-08 – ![GitHub stars](https://img.shields.io/github/stars/symfony/ai?style=social "Link to resource") – Symfony AI: built-in AI components and bundles for Symfony apps
...
* 🧪 [symfony/ai-platform](https://github.com/symfony/ai-platform "Link to resource") ⭐ 54 | 🐛 0 | 🌐 PHP | 📅 2026-09-06 – Experimental Symfony AI Platform component providing a unified abstraction for interacting with AI models, providers, messages, embeddings, speech, and provider-specific bridge packages
...
* [Awesome PHP](https://github.com/ziadoz/awesome-php "Link to resource") ⭐ 32,686 | 🐛 90 | 📅 2026-07-13
...
* [tensorflow/tfjs](https://github.com/tensorflow/tfjs "Link to resource") ⭐ 19,140 | 🐛 385 | 🌐 TypeScript | 📅 2026-06-23 – JavaScript machine learning platform for training and running models in the browser or Node.js (TensorFlow\.js)
